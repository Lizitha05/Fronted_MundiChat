    ...
    <header>
        <nav class="navbar">
            ...
            <div class="wrapper-opc">
                ...
                <a id="subtitulo" href="/index">INICIO</a>
            </div>

            <!-- Botón ingresar -->
            <div class="wrapper-btn">
                <a href="/login" class="btn-login">REGRESAR</a>
            </div>
    ...
    <div class="wrapperReg">
        ...
        <div class="bodyReg">
            ...
            <div class="perfilReg">
                ...
                <img id="preview" class="imgReg" src="/Image/perfil.png" alt="" onclick="document.getElementById('fileOpeneReg').click()">
            ...
            <div class="gridReg">
                ...
                <div class="flexReg">
                    <input class="iReg" type="password">
                     ...
                     <div class="iReg">
                        <button class="btn-reg"><a href="/profile">Registro</a></button>
                    </div>
                </div>
